...
{
	partial class InHousePartDataPanel
	{
		/// <summary> 
		...
		{
			this.MachineIdExtendedTextbox = new Shelves.GUI.Controls.Controls.ExtendedTextbox();
			...
			this.SuspendLayout();
			// 
			// MachineIdExtendedTextbox
			// 
			this.MachineIdExtendedTextbox.BackColor = System.Drawing.Color.Transparent;
			this.MachineIdExtendedTextbox.Label = "Machine ID";
			this.MachineIdExtendedTextbox.Location = new System.Drawing.Point(3, 173);
			this.MachineIdExtendedTextbox.Name = "MachineIdExtendedTextbox";
			this.MachineIdExtendedTextbox.Size = new System.Drawing.Size(300, 20);
			this.MachineIdExtendedTextbox.TabIndex = 6;
			this.MachineIdExtendedTextbox.Type = Shelves.GUI.Controls.Controls.ExtendedTextboxType.Int;
			// 
			...
			// 
			// InHousePartDataPanel
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.BackColor = System.Drawing.Color.Transparent;
			this.Controls.Add(this.MachineIdExtendedTextbox);
			...
			this.Name = "InHousePartDataPanel";
		...
		private Shelves.GUI.Controls.Controls.ExtendedTextbox MachineIdExtendedTextbox;
	}
}
