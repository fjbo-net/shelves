...
{
	partial class OutsourcedDataPanel
	{
		/// <summary> 
		...
		{
			this.CompanyNameExtendedTextbox = new Shelves.GUI.Controls.Controls.ExtendedTextbox();
			...
			this.SuspendLayout();
			// 
			// CompanyNameExtendedTextbox
			// 
			this.CompanyNameExtendedTextbox.BackColor = System.Drawing.Color.Transparent;
			this.CompanyNameExtendedTextbox.Label = "Company Name";
			this.CompanyNameExtendedTextbox.Location = new System.Drawing.Point(3, 173);
			this.CompanyNameExtendedTextbox.Name = "CompanyNameExtendedTextbox";
			this.CompanyNameExtendedTextbox.Size = new System.Drawing.Size(300, 20);
			this.CompanyNameExtendedTextbox.TabIndex = 6;
			this.CompanyNameExtendedTextbox.Type = Shelves.GUI.Controls.Controls.ExtendedTextboxType.Text;
			// 
			...
			this.Controls.Add(this.CompanyNameExtendedTextbox);
		...
		private Shelves.GUI.Controls.Controls.ExtendedTextbox CompanyNameExtendedTextbox;
	}
}
